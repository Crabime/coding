 ...
 */
public class BundleClError {

    public static void main(String[] args) throws MalformedURLException, ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {

        BundleClError clError = new BundleClError();

        URLClassLoader u1Cl = new URLClassLoader(clError.convertToURLArray(
                "/Users/crabime/IdeaProjects/coding/bundle/module1/target/module1-1.0-SNAPSHOT.jar"));

        URLClassLoader u2Cl = new URLClassLoader(clError.convertToURLArray(
    ...
    private URL[] convertToURLArray(String filePath) throws MalformedURLException {
